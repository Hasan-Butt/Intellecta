...
import { 
  Download, RefreshCw, ShieldCheck, Zap, BarChart3, Clock, Activity 
} from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen bg-[#F9FAFB] font-inter text-[#111827]">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-10 max-w-[1450px] mx-auto w-full space-y-10">
          {/* Header Section */}
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-4xl font-black tracking-tight text-[#111827]">System Analytics</h2>
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 lg:col-span-5 bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
              <div className="flex justify-between items-start mb-8">
                <div>
                  <p className="text-[12px] font-bold text-gray-400 uppercase tracking-[0.2em]">Active User Focus</p>
                  <h3 className="text-6xl font-black mt-4 tracking-tighter text-[#111827]">87.4%</h3>
                </div>
                <span className="bg-emerald-50 text-emerald-600 text-[11px] font-black px-3 py-1 rounded-xl border border-emerald-100">+1.2%</span>
              </div>
              ...
              <p className="text-[11px] text-gray-400 font-bold uppercase tracking-tight">Based on 1,240 concurrent learning sessions.</p>
            </div>
            ...
            <div className="col-span-12 lg:col-span-3 bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm flex flex-col justify-between">
              <div>
                <p className="text-[12px] font-bold text-gray-400 uppercase tracking-[0.2em]">Distractions</p>
                <div className="flex items-baseline gap-1 mt-6">
                  <h3 className="text-6xl font-black text-[#111827] tracking-tighter">3.2</h3>
                  <span className="text-gray-300 text-xl font-bold uppercase">/hr</span>
                </div>
              </div>
              <div className="flex items-center gap-3 text-red-500 mt-10">
                <Activity size={24} />
                <p className="text-[11px] font-black leading-tight uppercase tracking-widest">Decreasing Trend</p>
              </div>
            </div>

            {/* System Load Card */}
            <div className="col-span-12 lg:col-span-4 bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
              <p className="text-[12px] font-bold text-gray-400 uppercase tracking-[0.2em]">System Load</p>
              ...
              <p className="text-[11px] text-gray-400 mt-6 font-black uppercase tracking-[0.2em]">All Nodes Healthy</p>
            </div>
          </div>
            ...
            <div className="col-span-12 lg:col-span-4 space-y-8">
              <div className="bg-[#111827] p-10 rounded-[40px] text-white shadow-2xl relative overflow-hidden group">
                <div className="relative z-10">
                  ...
                  <h4 className="text-3xl font-black leading-tight">System Integrity 100%</h4>
                  <p className="text-sm text-gray-400 mt-4 font-bold leading-relaxed">
                    All cognitive edge nodes are synchronized. No latency detected in adaptive quiz engines.
                  </p>
              ...
              <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
                <h4 className="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-8">Distraction Sources</h4>
                  ...
                  {[
                    ...
                    <div key={item.label}>
                      ...
                      <div className="h-2 w-full bg-gray-50 rounded-full border border-gray-100">
                        <div className="h-full bg-[#6C5DD3] rounded-full" style={{width: `${item.value}%`}}></div>
                      </div>
                    </div>
                  ))}
                </div>
