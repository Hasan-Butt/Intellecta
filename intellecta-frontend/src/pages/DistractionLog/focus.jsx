  ...
  return (
    <div className="group flex items-center justify-between p-6 mb-4 bg-white rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-md transition-all duration-300 cursor-default">
      <div className="flex items-center gap-5">
        <div
          className={`p-4 rounded-xl ${isCritical ? "bg-red-50 text-red-500" : "bg-orange-50 text-orange-500"}`}
        >
          {isCritical ? (
        ...
        <div>
          <h4 className="text-[16px] font-bold text-gray-800 tracking-tight">
            {title}
          </h4>
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="text-right min-w-[80px]">
          <div
            className={`text-2xl font-black ${isCritical ? "text-red-700" : "text-[#7C4119]"}`}
          >
            {percentage}%
          </div>
            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              >
                ...
                <div className="relative h-72 w-full px-2">
                  ...
                  >
                    ...
                    <path
                      d="M0,160 C100,140 150,155 250,150 C300,145 320,110 380,105 C450,100 500,145 600,140 C750,135 800,80 900,100 C950,110 1000,140 1000,160 L1000,200 L0,200 Z"
                      fill="url(#areaGradient)"
                    />
                    <path
                      d="M0,160 C100,140 150,155 250,150 C300,145 320,110 380,105 C450,100 500,145 600,140 C750,135 800,80 900,100 C950,110 1000,140 1000,160"
                      fill="none"
                      stroke="#4F39C3"
                      strokeWidth="5"
                      strokeLinecap="round"
                ...
                <div className="bg-[#4F39C3] rounded-[32px] p-8 text-white shadow-xl shadow-indigo-100 flex flex-col justify-between h-full">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100 text-sm font-medium leading-relaxed">
                      Your focus consistency is 12% higher than your weekly
                      average.
                    </p>
                  </div>
                </div>
              ...
              <section className="col-span-12 lg:col-span-8 bg-white rounded-[32px] p-10 shadow-[0_20px_50_rgba(0,0,0,0.02)] border border-gray-100">
                <header className="flex justify-between items-center mb-10">
                  ...
                  <span className="text-sm font-bold text-indigo-600 cursor-pointer hover:underline">
                ...
                <nav className="space-y-2">
                  <MasteryItem
                    ...
                    subtitle="Schrödinger's Equation logic gaps"
                    percentage={42}
                    type="critical"
                  />
                  <MasteryItem
                    title="Multivariate Calculus"
                    subtitle="Triple integral volume calculations"
                    percentage={58}
                    type="warning"
                  />
                </nav>
                ...
                <div className="relative flex items-center justify-center my-8">
                  ...
                  >
                    ...
                    <circle
                      ...
                      fill="transparent"
                      strokeDasharray={circumference}
                      strokeDashoffset={circumference - circumference * 0.6}
                      strokeLinecap="round"
                    />
                  </svg>
              ...
              <div className="col-span-12 lg:col-span-7 flex flex-col gap-8">
                ...
                <section className="bg-white rounded-[32px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.02)] border border-gray-100 flex flex-col justify-center h-[242px]">
                  <h2 className="font-black text-xl tracking-tight text-[#4F39C3] uppercase mb-6">
                    Weekly Sanctuary Score
                  </h2>
                  <div className="flex items-center gap-8 mb-6">
                    <div className="flex-1 h-5 bg-[#E2E2F2] rounded-full overflow-hidden p-1">
                      <div
                        className="h-full bg-gradient-to-r from-[#5D5FEF] to-[#A5A6F6] rounded-full"
                        style={{ width: "85%" }}
                      />
                    </div>
                    <span className="text-5xl font-black text-[#4A4AB1]">
                      78
                    </span>
                  </div>
